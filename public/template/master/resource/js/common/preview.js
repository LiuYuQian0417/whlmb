...
this.imagePreview = function (d, c) {
    ...
    $(c).hover(function (e) {
        $("body").append("<div id='preview' class='previewShowWindow'><img id='pi' src='/template/master/resource/image/common/onLoad.gif' onerror=\"this.src='/template/master/resource/image/common/imageError.png'\" /></div>");
        var m = $(this).attr("rel");
        $("#pi").attr("src", m);
        var o = $("#preview").width();
