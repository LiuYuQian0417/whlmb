(function (window, $) {
    ...
    window.main = {
        ...
        viewText: function (id, parameter, url) {
            $('#' + parameter + id).html('<input type="text" style="text-align: center" id="data' + id + '" value="' + $('#' + parameter + id).text() + '" autocomplete="off" placeholder="请输入分类名称" class="layui-input" onblur=main.editText("' + id + '","' + parameter + '","' + url + '")>');
