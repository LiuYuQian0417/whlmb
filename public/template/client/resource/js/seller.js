$(function() {
	...
	$(document).click(function(e){
		...
		if(e.target.className !='cite' && !$(e.target).parents("div").is(".imitate_select")){
			$('.imitate_select ul').removeClass("block");
		}
	})
	...
	$(document).on("click",".imitate_select .cite",function(){
        ...
        $(".imitate_select ul").not($(this).next("ul")).removeClass('block');
	...
	$(document).on("click",".imitate_select li  a",function(){
		...
		_this.parents(".imitate_select").find("ul").removeClass('block');
	});
	//div仿select下拉选框 end
...
$(function(){
	...
	$("a[ectype='search']").on("click",function(){
		...
		function ajax(){
			$.ajax('get_ajax_content.php', 'act=filter_list&search_type='+search_type+search_data, function(data){
