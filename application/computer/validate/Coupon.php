...
class Coupon extends Validate
{
    ...
    protected $rule = [
        ...
        'classify_str|所属分类/店铺ID'       => 'require',
        'title|优惠券标题'                  => 'require|max:20',
        'actual_price|优惠券金额'           => 'require',
        'full_subtraction_price|满减金额'  => 'require|gt:actual_price',
        'total_num|优惠券数量'              => 'require|number',
        'start_time|使用时间区间'            => 'require',
        'end_time|使用时间区间'              => 'require|egt:start_time',
        'receive_start_time|优惠券领取开始时间' => 'require|elt:start_time',
        'receive_end_time|优惠券领取结束时间'   => 'require|egt:receive_start_time|elt:end_time',
    ];
    ...
    protected $message = [
        ...
        // 大禹添加
        'full_subtraction_price.gt'      => '必须大于优惠券金额',
        'end_time.egt'                   => '错误',
